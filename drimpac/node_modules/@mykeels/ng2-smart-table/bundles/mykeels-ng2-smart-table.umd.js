(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@mykeels/ng2-smart-table', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'ng2-completer', 'rxjs', 'lodash', 'rxjs/operators', '@angular/common/http'], factory) :
    (global = global || self, factory((global.mykeels = global.mykeels || {}, global.mykeels['ng2-smart-table'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.ng2Completer, global.rxjs, global.lodash, global.rxjs.operators, global.ng.common.http));
    ...
    ***************************************************************************** */
    ...
    var ServerDataSource = /** @class */ (function (_super) {
        ...
        function ServerDataSource(http, conf) {
            ...
            _this.onRequestStartSource = new rxjs.Subject();
            _this.onRequestEndSource = new rxjs.Subject();
            _this.onRequestCompleteSource = new rxjs.Subject();
            _this.onRequestErrorSource = new rxjs.Subject();
        ...
        ServerDataSource.prototype.requestElements = function () {
            ...
            return this.http.get(this.conf.endPoint, { params: httpParams, observe: 'response' }).pipe(operators.finalize(function () { return _this.emitOnRequestEnd(); })).pipe(operators.map(function (res) {
...
//# sourceMappingURL=mykeels-ng2-smart-table.umd.js.map
